...
describe('rest/index.js', () => {
  it.skip('should save', () => client.put('/things/00000000-0000-0000-0000-000000000000')
    .send(THING)
  ...
  it.only('should get', () => client.get('/things/00000000-0000-0000-0000-000000000000')
    // .set('Authorization', JWT)
    .expect(200)
    .expect((res) => {
      console.log('RES: %s', JSON.stringify(res, null, 2));
  ...
  it.skip('should query', () => client.get('/things')
    // .set('Authorization', JWT)
    .expect(200)
    .expect((res) => {
      // console.log('RES: %s', JSON.stringify(res, null, 2));
  ...
  it.skip('should delete', () => client.delete('/things/00000000-0000-0000-0000-000000000000')
    // .set('Authorization', JWT)
    .expect(200)
    .expect((res) => {
      // console.log('RES: %s', JSON.stringify(res, null, 2));
